...
App({
  onLaunch() {
    ...
    // 导航栏高度
    const { windowHeight,windowWidth, statusBarHeight,safeArea } = wx.getSystemInfoSync()
  ...
  globalData: {
    storeToken:null,
    openId:null,
    hostUri: 'https://api.ngj.nkdppf.com', // https://api.ngj.nkdppf.com, https://wxapp.ngj.nkdppf.com
